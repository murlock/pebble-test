...
func (c *serviceClient) Put(ctx context.Context, in *PutRequest, opts ...grpc.CallOption) (*PutReply, error) {
	out := new(PutReply)
...
func (c *serviceClient) Dump(ctx context.Context, in *DumpRequest, opts ...grpc.CallOption) (*DumpReply, error) {
	out := new(DumpReply)
	err := c.cc.Invoke(ctx, "/pb.Service/Dump", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ServiceServer interface {
	...
	Dump(context.Context, *DumpRequest) (*DumpReply, error)
...
func (UnimplementedServiceServer) Dump(context.Context, *DumpRequest) (*DumpReply, error) {
...
func _Service_Dump_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DumpRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ServiceServer).Dump(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.Service/Dump",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ServiceServer).Dump(ctx, req.(*DumpRequest))
	}
	return interceptor(ctx, in, info, handler)
}
